...
export interface Role {
  ...
  multi_sig_required?: number; // Numbers of approvals neededs for critical ops
  audit_log?: string[]; // Audit log for permissions changes with strings
  emergency_controls?: {
    enabled: boolean; // Whether emergency controls are active
    activated_by?: string; // Users who activated emergency
    activated_at?: Date;    // Timestamps when emergency was activated
  };
}
